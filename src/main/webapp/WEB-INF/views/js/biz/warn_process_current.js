...
//                {data: null, className:"center",defaultContent: 1},
            ...
            columnDefs: [
            	...
            	render:function(data,type,row,meta){
            		...
            		return "<a href='#' class='warning' class='tax-btn' fxId='"+row.fxId+"'>预警处理</a>";
            	}
            }]
        })
    }
...
//            		alert("请选择处理记录！");
               ...
               layer.open({
       			...
       			title:"预警处理",
       			area:['780px','400px'],
       			content:'/risk/doEnWarnProcessCurrentDetail?fxId='+fxId+'&uid='+$("#uid").val()+'&name='+$("#name").val()+'&examManagerDepart='+$("#examManagerDepart").val(),
       			end: function () { 
