...
<head>
    ...
    <meta charset="utf-8">
    <c:if test="${riskType == 'ADVANCE'}">
    	<title>事前预警待处理</title>
    </c:if>
    <c:if test="${riskType == 'CURRENT'}">
    	<title>事中预警待处理</title>
    </c:if>
...
<div class="mb10">
    <span><input id="warning" type="button" value="预警处理" class="tax-btn"></span>
...
<script src="<c:url value='/js/biz/warn_process.js'/> "></script>
<script>
    laydate.skin('danlan');
</script>
</html>
