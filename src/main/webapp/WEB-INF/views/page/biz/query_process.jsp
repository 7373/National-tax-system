...
<div class="form-box">
    <form id="qryForm">
        <div class="form-list pd14-mr">
            ...
            <div class="form-item clearfix">
            	<div class="col-4">
                    <label class="item-name label-name col-3"><span class="long-label">风险类别</span></label>
                   <div class="ipt-box col-8">
                        <select name="riskType" class="ipt-input clx" id="managerDepart">
	                        <option value="ADVANCE">事前风险</option>
	                        <option value="CURRENT">事中风险</option>
                        </select>
                    </div>
                </div>
            </div>
...
<script src='<c:url value="/js/biz/query_process.js" />'></script>
<script>
    laydate.skin('danlan');
</script>
</html>
