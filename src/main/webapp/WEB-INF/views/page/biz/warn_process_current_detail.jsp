        ...
        <form id="content_form">
            <div class="form-list filter-condition">
                <div class="form-item clearfix">
                    ...
                    <div class="col-5">
                        <label class="item-name col-3"><span class="long-label">补税金额</span></label>
                        <div class="col-7">
                            <div class="ipt-box col-12">
                               <input type="text" name="taxAmount" id="taxAmount" class="ipt-txt ipt-input">
                            </div>
                    </div>
                </div>
            </div>
...
<script src="<c:url value='/js/biz/warn_process_current_detail.js'/> "></script>
</html>
