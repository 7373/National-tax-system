        ...
        <div class="form-list pd14-mr">
            ...
            <div class="form-item clearfix">
                ...
                <div class="col-4">
                    ...
                    <label class="item-name label-name col-3 fr"><span class="long-label">管理科室</span></label>
                </div>
            </div>
           ...
           <input type='hidden' name="riskType" value="ADVANCE"/>
...
<script src='<c:url value="/js/biz/query_process_advance.js" />'></script>
<script>
    laydate.skin('danlan');
</script>
</html>
