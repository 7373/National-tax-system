...
import com.icinfo.tax.system.dto.PermisionTreeNode;
import com.icinfo.tax.system.dto.SysPermisionDto;
...
public class SysPermisionController extends BaseController {
    ...
    public String list() throws Exception {
        return "system/syspermision/list";
    }
    ...
    public AjaxResult listJSON() throws Exception {
        //查询所有权限
        List<SysPermision> permisions = sysPermisionService.selectAll();
        //构造ztree节点数据
    ...
    public ModelAndView show(String id, String sid) throws Exception {
        ModelAndView view = new ModelAndView("system/syspermision/edit");
